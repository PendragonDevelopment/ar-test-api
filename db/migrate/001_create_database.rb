...
class CreateDatabase < ActiveRecord::Migration
  ...
  add_index "users_profiles_fields", ["varname", "widget", "visible"], name: "varname", using: :btree

  create_table "view_questionratings", id: false, force: :cascade do |t|
    t.integer "cid",        limit: 4
    t.integer "qid",        limit: 4,                null: false
    t.decimal "thumbsUp",             precision: 23
    t.decimal "thumbsDown",           precision: 23
  end

  create_table "view_site_statitics_tbl", primary_key: "cid", force: :cascade do |t|
    t.integer "questionsServed", limit: 4,  null: false
    t.float   "totalPoints",     limit: 53, null: false
    t.float   "averagepoints",   limit: 53, null: false
    t.integer "usersTotal",      limit: 4,  null: false
    t.integer "quizcount",       limit: 4,  null: false
  end
  end
end
